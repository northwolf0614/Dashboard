 ...
 * @discussion This chart type has some specialties:
 ...
 */
@interface NChartFunnelSeries : NChartSolidSeries
 ...
 */
@interface NChartFunnelSeriesSettings : NChartSeriesSettings

/**
 * The sum of gaps between the points in the funnel chart in interval [0, 1]. The deafult value is 0.
 * @discussion Actual gap between the points is calculated as <code>gapSum / (countOfPoints - 1)</code> and 1
