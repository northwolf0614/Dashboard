 ...
 * value is YES.
 * @discussion If you have a lot of points that share the same cells, it is good idea to set this flag to YES
 ...
 * @discussion The difference from <code>fillRatio</code> is that <code>fillRatio</code> deals with the gap between column groups and
